...
tf.app.flags.DEFINE_integer('batch_size', 80, """The batch size to use.""")
tf.app.flags.DEFINE_integer('num_preprocess_threads', 4,
                            """How many preprocess threads to use.""")
tf.app.flags.DEFINE_string('train_dir', '/root/sharedfolder/flm/mdm/mdm/ckpt/train_22_concat3_last256',
                           """Directory where to write event logs """
                           """and checkpoint.""")
tf.app.flags.DEFINE_string('pretrained_model_checkpoint_path', '/root/sharedfolder/flm/mdm/mdm/ckpt/train_22_concat3_last256/model.ckpt',
                           """If specified, restore this pretrained model """
                           """before beginning any training.""")
tf.app.flags.DEFINE_string('pretrained_model_step', 2100,
...
tf.app.flags.DEFINE_string('datasets', ':'.join(
    ('/root/sharedfolder/flm/datasets/lfpw/trainset/*.png',  #image_080
     '/root/sharedfolder/flm/datasets/helen/trainset/*.jpg',
     '/root/sharedfolder/flm/datasets/afw/*.jpg')),     #7003
                           """Directory where to write event logs """
                           """and checkpoint.""")
tf.app.flags.DEFINE_integer('patch_size', 22, 'The extracted patch size')
...
def train(scope=''):
    ...
    with tf.Graph().as_default(), tf.device(FLAGS.train_device):
        ...
        if FLAGS.pretrained_model_step != '':
            ...
            step = FLAGS.pretrained_model_step + 1
